        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="bg-gray-800/50 rounded-lg p-4">
              ...
              <img
                src="/asset/img/project5_운행일지.webp"
                alt="운행일지 수기 작성"
                loading="lazy"
                decoding="async"
                ...
                onClick={() => onImageClick('/asset/img/project5_운행일지.webp')}
              />
            ...
            <div className="bg-gray-800/50 rounded-lg p-4">
              ...
              <img
                src="/asset/img/project5_거래내역엑셀시트.webp"
                alt="거래내역 엑셀시트"
                loading="lazy"
                decoding="async"
                className="w-full h-48 md:h-64 object-contain rounded filter blur-[0.7px] transition-transform duration-300 hover:scale-105 cursor-pointer"
                onClick={() => onImageClick('/asset/img/project5_거래내역엑셀시트.webp')}
              />
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-6 place-items-center">
            <div className="bg-gray-800/50 rounded-lg p-4">
              ...
              <img
                src="/asset/img/project5_배차관리엑셀시트.webp"
                alt="배차관리 엑셀시트"
                loading="lazy"
                decoding="async"
                ...
                onClick={() => onImageClick('/asset/img/project5_배차관리엑셀시트.webp')}
              />
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-gray-800/50 rounded-lg p-4">
              ...
              <img
                src="/asset/img/project5_대시보드화면.webp"
                alt="관리자 대시보드"
                loading="lazy"
                decoding="async"
                className="w-full h-48 md:h-64 object-contain rounded transition-transform duration-300 cursor-pointer hover:scale-105"
                onClick={() => onImageClick('/asset/img/project5_대시보드화면.webp')}
              />
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="bg-gray-800/50 rounded-lg p-4">
              ...
              <img
                src="/asset/img/project5_배차관리화면1.webp"
                alt="배차 관리 1"
                loading="lazy"
                decoding="async"
                className="w-full h-48 md:h-64 object-contain rounded transition-transform duration-300 cursor-pointer hover:scale-105"
                onClick={() => onImageClick('/asset/img/project5_배차관리화면1.webp')}
              />
            ...
            <div className="bg-gray-800/50 rounded-lg p-4">
              <h6 className="text-sm font-medium text-gray-200 mb-3">배차 관리 (어드민 페이지)</h6>
              <img
                src="/asset/img/project5_배차관리화면2.webp"
                alt="배차 관리 2"
                loading="lazy"
                decoding="async"
                className="w-full h-48 md:h-64 object-contain rounded transition-transform duration-300 cursor-pointer hover:scale-105"
                onClick={() => onImageClick('/asset/img/project5_배차관리화면2.webp')}
              />
      ...
      <div>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="bg-gray-800/50 rounded-lg p-4">
            ...
            <img
              src="/asset/img/project5_기사님페이지기간별통계화면.webp"
              alt="기간별 통계"
              loading="lazy"
              decoding="async"
              className="w-full h-48 md:h-64 object-contain rounded transition-transform duration-300 cursor-pointer hover:scale-105"
              onClick={() => onImageClick('/asset/img/project5_기사님페이지기간별통계화면.webp')}
            />
          ...
          <div className="bg-gray-800/50 rounded-lg p-4">
            ...
            <img
              src="/asset/img/project5_기사님페이지일별기록화면.webp"
              alt="일별 기록"
              loading="lazy"
              decoding="async"
              className="w-full h-48 md:h-64 object-contain rounded transition-transform duration-300 cursor-pointer hover:scale-105"
              onClick={() => onImageClick('/asset/img/project5_기사님페이지일별기록화면.webp')}
            />
          ...
          <div className="bg-gray-800/50 rounded-lg p-4">
            ...
            <img
              src="/asset/img/project5_기사님배차화면.webp"
              alt="기사님 배차"
              loading="lazy"
              decoding="async"
              className="w-full h-48 md:h-64 object-contain rounded transition-transform duration-300 cursor-pointer hover:scale-105"
              onClick={() => onImageClick('/asset/img/project5_기사님배차화면.webp')}
            />
